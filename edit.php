        ...
        <form action="?hal=edit" method="post">
            <table>
                ...
                <tr>
                    ...
                    <td>:&nbsp;<input type="text" name="nis" placeholder="Nomer Induk Siswa" value="<?= $row['nis'] ?>">
                    </td>
                </tr>
                <tr>
                    <td><label for="nisn">NISN</label></td>
                    <td>:&nbsp;<input type="text" name="nisn" placeholder="Nomer Induk Siswa Nasional"
                            value="<?= $row['nisn'] ?>"></td>
                </tr>
                <tr>
                    <td><label for="nama">Nama Siswa</label></td>
                    <td>:&nbsp;<input type="text" name="nama_siswa" placeholder="Nama Siswa"
                            value="<?= $row['nama_siswa'] ?>"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Jenis Kelamin</td>
                    <td>
                        <input <?= $row['jk'] == 'Laki-Laki' ? 'checked' : '' ?> type="radio" name="jk"
                            value="Laki-Laki">Laki-Laki
                        <input <?= $row['jk'] == 'Perempuan' ? 'checked' : '' ?> type="radio" name="jk"
